...
//        List localDataList = new ArrayList(Arrays.asList("milan","dingo", "elpha", "hafil", "meat", "iga", "neeta.peeta"));
//        List apiDataList = new ArrayList(Arrays.asList("elpha", "iga", "123", "meat", "dingo", "milan", "neeta.peeta"));
//
//        localDataList.removeAll( apiDataList );
//        System.out.println( localDataList );
//
//
//        if(listEqualsIgnoreOrder(localDataList, apiDataList)){
